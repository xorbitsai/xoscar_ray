...
from xoscar._utils import Timer
from xoscar.backends.communication.base import Channel, ChannelType, Client, Server
from xoscar.backends.communication.core import register_client, register_server
from xoscar.backends.communication.errors import ChannelClosed
from xoscar.debug import debug_async_timeout
from xoscar.errors import ServerClosed
from xoscar.metrics import Metrics
from xoscar.profiling import ProfilingData
from xoscar.serialization import deserialize, serialize
from xoscar.utils import classproperty, implements, lazy_import, lazy_import_on_load
...
@dataclass
class ExtendedChannelType(ChannelType):
...
def msg_to_simple_str(msg):  # pragma: no cover
    ...
    from xoscar.backends.message import SendMessage, _MessageBase
...
class RayChannelBase(Channel, ABC):
    ...
    def type(self) -> int:
        return ExtendedChannelType.ray
